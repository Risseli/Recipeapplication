...
const Login = () => {
  ...
  const loginUser = async () => {
    try {
      const response = await fetch("http://localhost:5140/api/User/login", { //localhost:5140/api/User/login...https://recipeappapi.azurewebsites.net/api/User/login
        method: "POST",
        headers: {
  ...
  const registerUser = async () => {
    try {
      const response = await fetch("http://localhost:5140/api/User/register", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const recoverPassword = async () => {
    try {
      const response = await fetch(`http://localhost:5140/api/User/RecoverPassword/${recoveryEmail}`, { //localhost:5140/api/User/RecoverPassword/{email}....`https://recipeappapi.azurewebsites.net/api/user/RecoveryPassword/${recoveryEmail}`
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        }
      ...
      <>
        ...
        <form>
          ...
          <p className="recover-password-text">
            Forgot your password? <a href="#" onClick={() => setRecoverPasswordPrompt(true)}>Click here to recover it.</a>
          </p>
          <div className="form-group">
